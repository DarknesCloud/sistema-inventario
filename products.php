            ...
            <tr id="<?php echo 'p_id_'.$product['id'];?>">
              ...
              <td class="text-center" style="vertical-align: middle">
                <div class="btn-group">
                  ...
                  <a href="delete_product.php?id=<?php echo (int)$product['id'];?>" data-toggle="tooltip" title="eliminar" onclick="return confirm('¿Estás seguro de que deseas eliminar este producto?');">
