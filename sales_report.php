                        ...
                        <div class="form-group d-block">
                            <div class="form-row border-0">
                                <div class="col border-0 d-inline-block" style="">
                                    ...
                                    <input type="text" class="form-control rounded" name="date-start" id="date-start"
                                        data-date data-date-format="yyyy-mm-dd"
                                        value="<?php echo ($date_start ? $date_start : date('Y-m-').'01'); ?>"
                                        placeholder="aaaa-mm-dd" style="width: 10em">
                                </div>

                                <div class="col border-0 d-inline-block" style="margin-left: 2em;">
                                    <label for="date-end" class="control-label">Hasta</label>
                                    <input type="text" class="form-control rounded" name="date-end" id="date-end"
                                        data-date data-date-format="yyyy-mm-dd"
                                        value="<?php echo ($date_end ? $date_end : date('Y-m-d')); ?>"
                                        placeholder="aaaa-mm-dd" style="width: 10em">
                                </div>

                                <div class="col border-0 d-inline-block" style="margin-left: 2em;">
                                    <button type="submit" name="btn_build_report" id="btn_build_report"
                                        class="btn btn-primary rounded">Generar</button>
                                </div>
                            </div>
                        </div>
                    </div>
