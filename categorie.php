                ...
                <tr>
                    ...
                    <td class="text-center">
                      <div class="btn-group">
                        ...
                        <a href="delete_categorie.php?id=<?php echo (int)$cat['id'];?>" data-toggle="tooltip" title="Eliminar" onclick="return confirm('¿Estás seguro de que deseas eliminar este producto?');">
