          ...
          <?php endif;?>
           ...
           <td class="text-center">
             <div class="btn-group">
                ...
                <a href="delete_user.php?id=<?php echo (int)$a_user['id'];?>" data-toggle="tooltip" data-placement="left" title="Eliminar" onclick="return confirm('¿Estás seguro de que deseas eliminar este producto?');">
